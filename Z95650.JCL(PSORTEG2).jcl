...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  DELETE Z95650.QSAM.AA NONVSAM
  IF LASTCC LE 08 THEN SET MAXCC = 00
//SORT0200 EXEC PGM=SORT
//SYSOUT   DD SYSOUT=*
//SORTIN   DD *
10001954CENGIZ         DISCI          20010625
10002765SUDE           SARIOGLU       20100705
10003978EY  MEN        DISCI          20020403
//SORTOUT  DD DSN=Z95650.QSAM.AA,
...
//FILE01   DD DSN=Z95650.QSAM.BB,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,0)
//SORT0400 EXEC PGM=SORT
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z95650.QSAM.AA,DISP=SHR
//SORTOUT  DD DSN=Z95650.QSAM.BB,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(5,5),RLSE),
